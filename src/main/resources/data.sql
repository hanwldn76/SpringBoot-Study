...
insert into member(email, password) values('1@naver.com', '1111');
insert into member(email, password) values('2@naver.com', '2222');
insert into member(email, password) values('3@naver.com', '3333');
